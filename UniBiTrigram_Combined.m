...
%% Make result folder
mkdir("CombinedLDAResultsUniBiTri")
cd CombinedLDAResultsUniBiTri/

%% Build combined word of bag
bagFDS = bagOfNgrams(documentsFDS,'NgramLengths',[1 2 3]);
bagFDS = removeInfrequentNgrams(bagFDS, 10, 'NgramLengths',[2 3]);
